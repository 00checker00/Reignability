...
(lib.card_activist = function() {
	this.initialize(img.card_activist);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,459,458);


(lib.card_president = function() {
	this.initialize(img.card_president);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,459,459);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.card_front).wait(1).to({regX:229.5,regY:229.5,x:229.5,y:229.5},0).wait(19).to({scaleX:0.779,skewY:-21.1562,x:229.4,y:229.35},0).wait(1).to({scaleX:0.5581,skewY:-42.3123,x:229.25},0).wait(1).to({scaleX:0.3371,skewY:-63.4685,x:229.1,y:229.4},0).to({_off:true},1).wait(6));
...
p.nominalBounds = new cjs.Rectangle(0,-86.6,461.4,631.7);
...
p.nominalBounds = new cjs.Rectangle(-540,-1253.8,1526,1715.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.card_front).wait(1).to({regX:229.5,regY:229.5,x:229.5,y:229.5},0).wait(19).to({scaleX:0.779,skewY:-21.1562,x:229.4,y:229.35},0).wait(1).to({scaleX:0.5581,skewY:-42.3123,x:229.25},0).wait(1).to({scaleX:0.3371,skewY:-63.4685,x:229.1,y:229.4},0).to({_off:true},1).wait(41));
...
p.nominalBounds = new cjs.Rectangle(-1254.4,-86.6,2714.3,1254.8999999999999);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/card_activist.png?1620854903490", id:"card_activist"},
		{src:"images/card_president.png?1620854903490", id:"card_president"},
		{src:"images/pollution.jpg?1620854903490", id:"pollution"}
	],
	preloads: []
};
