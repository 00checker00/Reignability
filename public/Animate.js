...
lib.ssMetadata = [
		{name:"Animate_atlas_1", frames: [[0,624,1263,173],[0,0,1018,622],[1020,0,1018,622]]}
];
...
(lib.CachedBmp_2Kopie2 = function() {
	this.initialize(ss["Animate_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.president_card_back = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#A8FFAE").s().p("");
	this.shape.setTransform(229.1,229.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#004D87").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.president_card_back, new cjs.Rectangle(0,0,458.2,458.2), null);
...
(lib.buttion_what = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.president_card_deck = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {"default":0,draw:1};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	// Ebene_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#004D87").s().p("");
	this.shape.setTransform(229.1,229.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#A8FFAE").s().p("");
	this.shape_1.setTransform(229.1,229.1);

	this.instance = new lib.president_card_back();
	this.instance.setTransform(229.1,229.1,1,1,0,0,0,229.1,229.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(1).to({scaleX:0.8343,skewY:-15.8671,x:229.05},0).wait(1).to({scaleX:0.6686,skewY:-31.7342},0).wait(1).to({scaleX:0.5028,skewY:-47.6014,x:229.1},0).wait(1).to({scaleX:0.3371,skewY:-63.4685,x:229.05},0).wait(1));

	// Ebene_2
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A8FFAE").s().p("");
	this.shape_2.setTransform(229.1,229.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#004D87").s().p("");
...
p.nominalBounds = new cjs.Rectangle(0,-77,458.2,612.3);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({_off:false},0).wait(25));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(16).to({_off:false},0).wait(25));

	// Ebene_1
	this.instance_1 = new lib.president_pic();
	this.instance_1.setTransform(105.75,104,1,1,0,0,0,105.8,104);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({scaleX:1.0541,scaleY:1.0541,rotation:-0.0215},0).wait(1).to({scaleX:1.1081,scaleY:1.1081,rotation:-0.043,x:105.8,y:104.05},0).wait(1).to({scaleX:1.1622,scaleY:1.1622,rotation:-0.0645,y:104},0).wait(1).to({scaleX:1.2162,scaleY:1.2162,rotation:-0.086,x:105.75,y:104.05},0).wait(1).to({scaleX:1.2703,scaleY:1.2703,rotation:-0.1075,x:105.8},0).wait(1).to({scaleX:1.3243,scaleY:1.3243,rotation:-0.129,x:105.75,y:104.1},0).wait(1).to({scaleX:1.3784,scaleY:1.3784,rotation:-0.1505,x:105.8,y:104.05},0).wait(1).to({scaleX:1.4324,scaleY:1.4324,rotation:-0.172},0).wait(1).to({scaleX:1.4865,scaleY:1.4865,rotation:-0.1935,x:105.75},0).wait(1).to({scaleX:1.5405,scaleY:1.5405,rotation:-0.215,x:105.8},0).wait(1).to({scaleX:1.5946,scaleY:1.5946,rotation:-0.2365},0).wait(1).to({scaleX:1.6487,scaleY:1.6487,rotation:-0.258,x:105.75},0).wait(1).to({scaleX:1.7027,scaleY:1.7027,rotation:-0.2795},0).wait(1).to({scaleX:1.7568,scaleY:1.7568,rotation:-0.301},0).wait(1).to({scaleX:1.8108,scaleY:1.8108,rotation:-0.3225,x:105.8,y:104},0).wait(1).to({scaleX:1.8649,scaleY:1.8649,rotation:-0.344,x:105.75,y:104.05},0).wait(1).to({rotation:-0.3655,x:105.8,y:104.1},0).wait(1).to({rotation:-0.387,x:105.75,y:104.05},0).wait(1).to({rotation:-0.4085,x:105.8,y:104.1},0).wait(1).to({rotation:-0.43,y:104.05},0).wait(1).to({rotation:-0.4515,y:104.1},0).wait(1).to({rotation:-0.473,y:104.05},0).wait(1).to({rotation:-1.3415,y:104.1},0).wait(1).to({rotation:-2.21},0).wait(1).to({rotation:-3.0785,x:105.75,y:104.05},0).wait(1).to({rotation:-3.9471,x:105.8},0).wait(1).to({rotation:-4.8156},0).wait(1).to({rotation:-5.6841},0).wait(1).to({rotation:-3.977,x:105.75},0).wait(1).to({rotation:-2.2699,x:105.8,y:104.1},0).wait(1).to({rotation:-0.5628,y:104.05},0).wait(1).to({rotation:1.1442},0).wait(1).to({rotation:2.8513,x:105.75},0).wait(1).to({scaleX:1.8648,scaleY:1.8648,rotation:4.5584,x:105.8,y:104.1},0).wait(1).to({scaleX:1.8649,scaleY:1.8649,rotation:3.7987,x:105.75,y:104.05},0).wait(1).to({rotation:3.0389},0).wait(1).to({rotation:2.2792,x:105.8,y:104.1},0).wait(1).to({rotation:1.5195,y:104.05},0).wait(1).to({scaleX:1.8648,scaleY:1.8648,rotation:0.7597,y:104.1},0).wait(1).to({rotation:0,x:105.75,y:104.05},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-264.7,-94.2,721.8,856.9000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.button_what = new lib.buttion_what();
...
if (reversed == null) { reversed = false; }
	...
	// Ebene_7
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#B8FFBC").s().p("");
	this.shape.setTransform(356.7,116.925);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#36803A").s().p("");
	this.shape_1.setTransform(360.35,93.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#3C543D").s().p("Eg4SAAwIAAhfMBwlAAAIAABfg");
	this.shape_2.setTransform(360.35,192.275);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Ebene_3
	this.instance = new lib.president_card_deck();
	this.instance.setTransform(375.8,670,1,1,0,0,0,229.1,229.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Ebene_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4F6F75").s().p("EgffAjoQhvAAhOhOQhOhOAAhvMAAAg/QQAAhJAig6QASgeAagbIAAgBQAlgkAsgTQgRAsAAAzMAAAA/PQAABwBOBNQBOBPBvgBMA/QAAAQA6AAAygVQgUAygqArQgqApgzAVQgsAQgzAAg");
	this.shape_3.setTransform(345.175,700.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#8B8B8B").s().p("EghzAl5QhuAAhPhPQhNhNAAhvMAAAg/QQAAhuBNhOIAAgBQAqgpA0gTQgjA6ABBJMAAAA/QQAABvBOBNQBNBPBwAAMA/PAAAQAzAAAtgRQgSAegbAaQhOBPhuAAgEgdcAhtQhuAAhPhOQhNhOAAhvMAAAg/PQgBgzASgsQASg0AqgqIAAAAQBPhOBuAAMA/QAAAQBuAABOBOQBPBOAABvMAAAA/PQAABvhPBOQglAlgrATQgyAWg6AAg");
	this.shape_4.setTransform(346.25,697.775);
